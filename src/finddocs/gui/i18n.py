...
MODEL_DEVICE_HINT = (
    "Obliczenia na karcie graficznej wymagają pakietu onnxruntime-directml (DirectML) "
    "albo onnxruntime-gpu (CUDA). Gdy wybranego urządzenia nie ma w środowisku, "
    "obliczenia wracają na procesor. Zmiana urządzenia nie wymaga przebudowy indeksu."
)

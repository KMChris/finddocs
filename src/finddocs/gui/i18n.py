...
MODEL_DEVICE_HINT = (
    ...
    "instalowanego dodatkiem finddocs[gpu-dml] (DirectML, zalecane na Windows) albo "
    "finddocs[gpu-cuda] (CUDA, tylko NVIDIA); opis w instrukcji administratora. "
    "Na karcie graficznej najszybszy jest pełny model FP32, wariant INT8 zostaw "
    "procesorowi. Gdy wybranego urządzenia nie ma w środowisku, obliczenia wracają "
    "na procesor. Zmiana samego urządzenia nie wymaga przebudowy indeksu."
)
...
MODEL_REMOTE_PROTOCOL_FINDDOCS = "Wewnętrzny (FindDocs)"
MODEL_REMOTE_PROTOCOL_OPENAI = "Zgodny z OpenAI"

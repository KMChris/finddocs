...
MODEL_DEVICE_HINT = (
    ...
    "instalowanego z pliku requirements-gpu-cuda.txt (karty NVIDIA, najszybszy zmierzony "
    "wariant) albo requirements-gpu-dml.txt (DirectML, dowolna karta na Windows); opis "

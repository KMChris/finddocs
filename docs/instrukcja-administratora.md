...
`FindDocs-0.2.2-instalator.exe` instaluje aplikację w profilu użytkownika
...
```bat
FindDocs-0.2.2-instalator.exe /VERYSILENT /CURRENTUSER /NORESTART /SUPPRESSMSGBOXES
```

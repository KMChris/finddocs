...
Dokument wygenerowany automatycznie przez `tools/gen_sbom.py` dla wersji 0.2.0.
...
| h11 | 0.16.0 | MIT License | zaleznosc posrednia | https://github.com/python-hyper/h11 |
| httpcore | 1.0.9 | BSD License | zaleznosc posrednia | https://www.encode.io/httpcore |
| httpx | 0.28.1 | BSD License | klient HTTP dla Microsoft Graph | https://www.python-httpx.org |
| huggingface_hub | 0.36.2 | Apache Software License | zaleznosc posrednia | https://github.com/huggingface/huggingface_hub |
| humanfriendly | 10.0 | MIT License | zaleznosc posrednia | https://humanfriendly.readthedocs.io |
...
## Komponenty wymagajace weryfikacji licencji

Wszystkie zainstalowane pakiety deklaruja licencje w metadanych.

## Komponenty swiadomie odrzucone

| Komponent | Licencja | Powod odrzucenia | Zastosowane rozwiazanie |
| --- | --- | --- | --- |
| PyMuPDF | AGPL-3.0 albo komercyjna | AGPL jest trudna do przyjecia w srodowisku korporacyjnym | pypdfium2 (Apache-2.0 i BSD-3-Clause) |
| extract-msg | GPL-3.0 | GPL wymusza warunki na calej aplikacji | wlasny czytnik MSG oparty na olefile (BSD) |
| PyQt6 | GPL-3.0 albo komercyjna | wymagalaby zakupu licencji komercyjnej | PySide6 (LGPL-3.0) |

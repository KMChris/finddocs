...
GLYPHS: dict[str, tuple[float, tuple[Op, ...]]] = {
    ...
    # Glify rodzin plikow na karcie wyniku. Wspolna baza to kartka z zagietym
    # rogiem, wnetrze mowi o rodzinie. Poczta jest koperta bez kartki, bo
    # koperta w kartce bylaby nieczytelna przy 16 pikselach.
    "file-generic": (
        1.4,
        (
            ("poly", ((4.4, 2.8), (9.4, 2.8), (12.0, 5.4), (12.0, 13.2), (4.4, 13.2))),
            ("line", ((9.4, 2.8), (9.4, 5.4), (12.0, 5.4))),
        ),
    ),
    "file-text": (
        1.4,
        (
            ("poly", ((4.4, 2.8), (9.4, 2.8), (12.0, 5.4), (12.0, 13.2), (4.4, 13.2))),
            ("line", ((9.4, 2.8), (9.4, 5.4), (12.0, 5.4))),
            ("line", ((6.2, 8.6), (10.2, 8.6))),
            ("line", ((6.2, 10.8), (9.2, 10.8))),
        ),
    ),
    "file-table": (
        1.4,
        (
            ("poly", ((4.4, 2.8), (9.4, 2.8), (12.0, 5.4), (12.0, 13.2), (4.4, 13.2))),
            ("line", ((9.4, 2.8), (9.4, 5.4), (12.0, 5.4))),
            ("line", ((6.2, 8.2), (10.2, 8.2))),
            ("line", ((6.2, 10.4), (10.2, 10.4))),
            ("line", ((8.2, 7.2), (8.2, 11.4))),
        ),
    ),
    "file-image": (
        1.4,
        (
            ("poly", ((4.4, 2.8), (9.4, 2.8), (12.0, 5.4), (12.0, 13.2), (4.4, 13.2))),
            ("line", ((9.4, 2.8), (9.4, 5.4), (12.0, 5.4))),
            ("ellipse", (6.3, 7.3, 1.4, 1.4)),
            ("line", ((6.2, 11.3), (8.1, 9.1), (9.2, 10.3), (10.2, 9.3))),
        ),
    ),
    "file-mail": (
        1.4,
        (
            ("rrect", (2.8, 4.4, 10.4, 7.2, 1.2)),
            ("line", ((3.6, 5.4), (8.0, 8.8), (12.4, 5.4))),
        ),
    ),
}
